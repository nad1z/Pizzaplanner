...
export const FLOURS: FlourData[] = [
  ...
  },
  {
    ...
    not_ideal_for: ['Neapolitan'],
    style_scores: { Neapolitan: 1, 'New York': 4, Roman: 3, Brooklyn: 4, Detroit: 5, Sicilian: 5 },
  },
  {
    ...
    not_ideal_for: ['Detroit'],
    style_scores: { Neapolitan: 4, 'New York': 3, Roman: 5, Brooklyn: 3, Detroit: 2, Sicilian: 3 },
  },
  {
    name: 'Shtybel Pizza',
    brand: 'Shtybel',
    ...
    not_ideal_for: ['Detroit', 'Sicilian'],
    style_scores: { Neapolitan: 5, 'New York': 4, Roman: 3, Brooklyn: 3, Detroit: 1, Sicilian: 2 },
  },
  {
    ...
    secondary_styles: ['New York'],
    not_ideal_for: ['Detroit', 'Sicilian'],
    style_scores: { Neapolitan: 4, 'New York': 3, Roman: 4, Brooklyn: 2, Detroit: 1, Sicilian: 1 },
  },
  {
